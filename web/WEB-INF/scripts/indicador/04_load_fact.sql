...
CREATE TABLE FACT_INDICADORES_DCS (
  ...
  "FK_FECHA" NUMBER(*,0), 
	...
	"FK_NIVEL" NUMBER(*,0),
  "FK_TIPO" NUMBER(*,0),
  MD_COSTO_CU_FLETEADA NUMBER,
  MD_COSTO_CU_FLETEADA_PA NUMBER,
  MD_DIAS_PISO_PT NUMBER,
  MD_DIAS_PISO_PT_PA NUMBER,
  MD_PORCENTJE_ABASTO NUMBER,
  MD_PORCENTJE_ABASTO_PA NUMBER,
...
SELECT 
  ...
  NVL(DTD.PK_TIPO,0),
  COSTO_CU_FLETEADA,
  COSTO_CU_FLETEADA_PA,
  DIAS_PISO_PT,
  DIAS_PISO_PT_PA,
  PORCENTAJE_ABASTO,
  PORCENTAJE_ABASTO_PA,
	PRODUCTIVIDAD,
  PRODUCTIVIDAD_PA,
